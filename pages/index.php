                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="erkek" name="personel_cinsiyet"
                                                value="erkek" checked>
                                            <label for="erkek" class="custom-control-label">Erkek</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="kadın" name="personel_cinsiyet"
                                                value="kadın">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="evli" name="personel_medeni"
                                                value="evli" >
